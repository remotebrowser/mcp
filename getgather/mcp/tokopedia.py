...
@tokopedia_mcp.tool
async def remote_search_product(
    keyword: str | list[str],
    page_number: int = 1,
) -> dict[str, Any]:
    """Search products on Tokopedia."""
...
@tokopedia_mcp.tool
async def remote_get_product_details(product_url: str) -> dict[str, Any]:
    """Get product details from tokopedia. Get product_url from search_product tool."""
...
@tokopedia_mcp.tool
async def remote_search_shop(keyword: str) -> dict[str, Any]:
    """Search shop on tokopedia."""
    encoded_keyword = quote(keyword)
    url = f"https://www.tokopedia.com/search?st=shop&q={encoded_keyword}"
    return await remote_zen_dpage_mcp_tool(
...
@tokopedia_mcp.tool
async def remote_get_shop_details(
    product_url: str | None = None,
    shop_url: str | None = None,
) -> dict[str, Any]:
    """Get store details from tokopedia by product_url or shop_url. Get product_url from search_product tool or shop_url from search_shop tool.
...
@tokopedia_mcp.tool
async def remote_get_wishlist(page_number: int = 1) -> dict[str, Any]:
    """Get wishlist from tokopedia."""
